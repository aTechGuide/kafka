...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2572865837180925527L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddress\",\"namespace\":\"guide.atech.schema.avro\",\"fields\":[{\"name\":\"AddressLine\",\"type\":[\"null\",\"string\"]},{\"name\":\"City\",\"type\":[\"null\",\"string\"]},{\"name\":\"State\",\"type\":[\"null\",\"string\"]},{\"name\":\"ContactNumber\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public DeliveryAddress(java.lang.CharSequence AddressLine, java.lang.CharSequence City, java.lang.CharSequence State, java.lang.CharSequence ContactNumber) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: ContactNumber = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static guide.atech.schema.avro.DeliveryAddress.Builder newBuilder() {
    return new guide.atech.schema.avro.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static guide.atech.schema.avro.DeliveryAddress.Builder newBuilder(guide.atech.schema.avro.DeliveryAddress.Builder other) {
    return new guide.atech.schema.avro.DeliveryAddress.Builder(other);
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static guide.atech.schema.avro.DeliveryAddress.Builder newBuilder(guide.atech.schema.avro.DeliveryAddress other) {
    return new guide.atech.schema.avro.DeliveryAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guide.atech.schema.avro.DeliveryAddress.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.ContactNumber)) {
        this.ContactNumber = data().deepCopy(fields()[3].schema(), other.ContactNumber);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guide.atech.schema.avro.DeliveryAddress other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.DeliveryAddress.Builder clearContactNumber() {
      ContactNumber = null;
    ...
    public DeliveryAddress build() {
      try {
        ...
        record.ContactNumber = fieldSetFlags()[3] ? this.ContactNumber : (java.lang.CharSequence) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
