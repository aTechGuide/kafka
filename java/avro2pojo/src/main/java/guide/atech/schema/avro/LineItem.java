...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4276846163751270615L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineItem\",\"namespace\":\"guide.atech.schema.avro\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemDescription\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public static guide.atech.schema.avro.LineItem.Builder newBuilder() {
    return new guide.atech.schema.avro.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static guide.atech.schema.avro.LineItem.Builder newBuilder(guide.atech.schema.avro.LineItem.Builder other) {
    return new guide.atech.schema.avro.LineItem.Builder(other);
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static guide.atech.schema.avro.LineItem.Builder newBuilder(guide.atech.schema.avro.LineItem other) {
    return new guide.atech.schema.avro.LineItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guide.atech.schema.avro.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guide.atech.schema.avro.LineItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guide.atech.schema.avro.LineItem.Builder clearTotalValue() {
      TotalValue = null;
