    ...
    extends Invoice
{
    ...
    @Override
    public Notification withCreatedTime(Long createdTime) {
        super.withCreatedTime(createdTime);
        return this;
    }

    @Override
    public Notification withCustomCardNo(String customCardNo) {
        super.withCustomCardNo(customCardNo);
        return this;
    }

    @Override
    public Notification withNumberOfItem(Integer numberOfItem) {
        super.withNumberOfItem(numberOfItem);
        return this;
    }

    @Override
    public Notification withPaymentMethod(String paymentMethod) {
        super.withPaymentMethod(paymentMethod);
        return this;
    }

    @Override
    public Notification withInvoiceLineItems(List<LineItem> invoiceLineItems) {
    ...
    public String toString() {
        return new ToStringBuilder(this).appendSuper(super.toString()).append("invoiceNumber", invoiceNumber).append("customerCardNo", customerCardNo).append("totalAmount", totalAmount).append("earnedLoyaltyPoints", earnedLoyaltyPoints).append("totalLoyaltyPoints", totalLoyaltyPoints).toString();
    }
